...
{
    public class TenantRedisHashCacheService : ITenantHashCacheService
    {

        private readonly CSRedisClient _redisClient;
        private readonly ICXLUserClaimsService _cXLUserClaimsService;

        public TenantRedisHashCacheService(CSRedisClient redisClient, ICXLUserClaimsService cXLUserClaimsService)
        {
